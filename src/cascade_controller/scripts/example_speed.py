...
class MotorControlGroupPublisher(Node):
    def __init__(self):
        ...
        self.publisher_ = self.create_publisher(MotorControlGroup, 'mit_mode_control', 10)
    ...
    def timer_callback(self):
        ...
        motor1.set_point.effort = 0.924 * 9.81 * 0.09 * math.sin( self.current_position[0] ) 
        motor1.set_point.kp = 0.4
        motor1.set_point.kd = 0.05

        print(0.924 * 9.81 * 0.09 * math.sin( self.current_position[0] ) )
        # motor2 = MotorControl()
        # motor2.motor_id = 2
